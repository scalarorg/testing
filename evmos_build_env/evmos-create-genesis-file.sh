...
GENESIS_VAL1_MNEMONIC="display push brief egg scan entry inform record adjust fossil boss egg comic alien upon aspect dry avoid interest fury window hint race symptom"
...
total_supply=1800000000000000000000010000
...
do
	...
	$CHAIND gentx ${!KEYNAME} 1000000000000000000000aevmos --gas-prices ${BASEFEE}aevmos --keyring-backend "$KEYRING" --chain-id "$CHAIN_ID" --home "$BUILD_DIR" --moniker $NODE_MONIKER --ip 192.169.10.$((1 + $i))
